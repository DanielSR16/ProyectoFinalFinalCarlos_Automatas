...
d = '(e01,H)-(E02,H,R)-(d01,H)-(D02,H,R)-(d01,0)-(d02,0,R)-(d01,1)-(d12,1,R)-(d01,2)-(d22,2,R)-(d01,3)-(d32,3,R)-(d01,4)-(d42,4,R)-(d01,5)-(d52,5,R)-(d01,6)-(d62,6,R)-(d01,7)-(d72,7,R)-(d01,8)-(d82,8,R)-(d01,9)-(d92,9,R)-(D02,B)-(D03,B,R)-(D03,B)-(D03,propa,S)-(d14,B)-(d15,triaconta,R)-(d15,B)-(d15,B,S)-'
...
e2 = '(e13,B)-(e14,hen,R)-(e23,B)-(e14,do,R)-(e33,B)-(e14,tri,R)-(e43,B)-(e14,tetra,R)-(e53,B)-(e14,penta,R)-(e63,B)-(e14,hexa,R)-(e73,B)-(e14,hepta,R)-(e83,B)-(e14,octa,R)-(e93,B)-(e14,nona,R)-'
